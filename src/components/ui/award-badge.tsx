...
export const AwardBadge = ({ type, place, link, certificateName, organization, platform, date }: AwardBadgeProps) => {
  ...
  return (
    <a
      ...
      href={link}
      target="_blank"
      className="block w-[300px] sm:w-[360px] h-auto cursor-pointer"
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 75" className="w-[300px] sm:w-[360px] h-auto">
          <defs>
            <filter id="blur1">
              <feGaussianBlur in="SourceGraphic" stdDeviation="3" />
            </filter>
            <mask id="badgeMask">
              <rect width="360" height="75" fill="white" rx="12" />
            </mask>
          </defs>
          <rect width="360" height="75" rx="12" fill={backgroundColor[(place || 2) - 1] || backgroundColor[1]} />
          <rect x="6" y="6" width="348" height="63" rx="10" fill="transparent" stroke="#bbb" strokeWidth="1" />
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="11" fontWeight="bold" fill="#666" x="70" y="22">
            {organization || "ORGANIZATION"}
          </text>
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="14" fontWeight="bold" fill="#666" x="70" y="42">
            {certificateName ? 
              (certificateName.length > 35 ? 
                certificateName.substring(0, 32) + "..." : 
                certificateName) : 
              title[type]}
          </text>
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="10" fill="#666" x="70" y="58">
            {platform && date ? `${platform} • ${date}` : (platform || date || "")}
          </text>
          ...
          <g style={{ mixBlendMode: "overlay" }} mask="url(#badgeMask)">
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="hsl(358, 100%, 62%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="hsl(30, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="hsl(60, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="hsl(96, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="hsl(233, 85%, 47%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="hsl(271, 85%, 47%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="hsl(300, 20%, 35%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="transparent" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
            ...
            <g style={{
              ...
              <polygon points="0,0 360,75 360,0 0,75" fill="white" filter="url(#blur1)" opacity="0.5" />
            </g>
          </g>
        </svg>
      </div>
